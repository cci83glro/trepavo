                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="site-footer__bottom-inner">
                            <p class="site-footer__bottom-text">&copy; Copyright, <span class="dynamic-year"></span> <a
                                    href="#">Trepavo</a>
                            </p>
                        </div>
                    </div>
        ...
        <div class="mobile-nav__content">
            ...
            <ul class="mobile-nav__contact list-unstyled">
                <li>
                    ...
                    <a href="mailto:info@trepavo__.com">info@trepavo.com</a>
                </li>
                <li>
                    <i class="fa fa-phone-alt"></i>
                    <a href="tel:+45 60 54 30 77 ">+45 60 54 30 77</a>
                </li>
            </ul><!-- /.mobile-nav__contact -->
            <div class="mobile-nav__top">
                <div class="mobile-nav__social">
                    <a href="https://www.facebook.com/trepavocreativeagency" class="fab fa-facebook-square"></a>
