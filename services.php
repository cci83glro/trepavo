...
<section class="services-section">
    <div class="services-section-shape"
        style="background-image: url(assets/images/shapes/services-section-shape.png)"></div>
    <div class="container">
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                    ...
                    <div class="services-section__single">
                        <div class="services-section_icon">
                            <span class="icon-online-shopping"></span>
                        </div>
                        <h3 class="services-section__title"><a href="mobile-application.html">mobile <br>
                                application</a></h3>
                        <p class="services-section__text">Lorem ipsum is noted are many variations of have in pass
                            majy.</p>
                        <div class="services-section__btn-box">
                            <a href="mobile-application.html" class="services-section__btn">Read More</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="400ms">
                    ...
                    <div class="services-section__single">
                        ...
                        <h3 class="services-section__title"><a href="digital-marketing.html">digital <br>
                                marketing</a></h3>
                        <p class="services-section__text">Lorem ipsum is noted are many variations of have in pass
                            majy.</p>
                        <div class="services-section__btn-box">
                            <a href="digital-marketing.html" class="services-section__btn">Read More</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="600ms">
                    ...
                    <div class="services-section__single">
                        ...
                        <h3 class="services-section__title"><a href="website-development.html">Website <br>
                                development</a></h3>
                        <p class="services-section__text">Lorem ipsum is noted are many variations of have in pass
                            majy.</p>
                        <div class="services-section__btn-box">
                            <a href="website-development.html" class="services-section__btn">Read More</a>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <div class="services-section__bottom">
            <p class="services-section__bottom-text">Trepavo services built specifically for your business. <a
